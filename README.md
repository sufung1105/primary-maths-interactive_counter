# primary-maths-interactive_counter
Curriculum / Assessment Material: Interactive Primary Maths – Addition &amp; Subtraction Target: Primary students Format: Interactive HTML activity Purpose: Develop understanding of addition and subtraction through visual representations and immediate feedback.
...
Students enter an initial number and click Enter.

The corresponding number of counting sticks is displayed.
...
Students enter a number and select either:

Addition
Subtraction

The activity then displays the operation visually and mathematically.

For example:

3 + 2 = 5

The visual representation shows the original 3 sticks together with 2 additional sticks, followed by the result of 5 sticks.

3. Continue the Operations
...
Understands the meaning of addition and subtraction.

Can connect quantities with numerical symbols.

Makes errors when changing from a visual representation to an equation.

Needs additional support with number sense or basic operations.
...
This is an independently designed interactive learning material created for educational use.
